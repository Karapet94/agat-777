            ...
            <ul id="gallery" class="connectedSortable">
                ...
                foreach ($galleryData as $gallery) { ?>
                    <li class="ui-state-default form-control" data-id="<?php echo $gallery['id'] ?>">
                        <a href="<?php echo base_url() . UPLOADS_PATH_SERVICES_GALLERY_READ . $gallery['image'] ?>">
                            <img src="<?php echo base_url() . UPLOADS_PATH_SERVICES_GALLERY_READ . $gallery['image'] ?>" alt="pic">
                        </a>
